...
const mutations = {
  [types.works.mutations.SET_WORKS]: (
    currentState,
    { works, requestSource }
  ) => {
  ...
  [types.works.mutations.SET_IS_HOME_PAGE_WORKS_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.works.mutations.SET_IS_WORK_SECTIONS_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.works.mutations.REMOVE_DELETED_WORK_SECTION]: (
    currentState,
    index
  ) => {
...
const deleteWorkColumnData = async ({ commit }, payload) => {
  ...
  try {
    ...
    commit(
      types.works.mutations.REMOVE_DELETED_WORK_COLUMN,
      locationInDataArray
    );
    commit(types.app.mutations.SET_SPINNER_FLAG, false);
  } catch (error) {
