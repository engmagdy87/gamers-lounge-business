...
const mutations = {
    [types.about.mutations.SET_ABOUT]: (currentState, { about, requestSource }) => {
        if (!about) return
    ...
    [types.about.mutations.SET_IS_WEBSITE_ABOUT_FETCHED]: (currentState, flag) => {
    ...
    [types.about.mutations.SET_IS_ABOUT_SECTIONS_FETCHED]: (currentState, flag) => {
    ...
    [types.about.mutations.SET_IS_ABOUT_SECTION_FETCHED]: (currentState, flag) => {
    ...
    [types.about.mutations.SET_IS_ABOUT_COLUMNS_FETCHED]: (currentState, flag) => {
        currentState.isAboutRowFetched = flag;
    },
    [types.about.mutations.REMOVE_DELETED_ABOUT_SECTION]: (currentState, index) => {
    ...
    [types.about.mutations.REMOVE_DELETED_ABOUT_COLUMN]: (currentState, index) => {
...
const createAboutData = async ({ commit }, data) => {
    ...
    try {
        ...
        commit(types.about.mutations.SET_ABOUT, { about: response, requestSource: 'dashboard' })
        commit(types.app.mutations.SET_SPINNER_FLAG, false)
        return response
    } catch (error) {
        commit(types.app.mutations.SET_SPINNER_FLAG, false)
...
const deleteAboutSectionData = async ({ commit }, payload) => {
    ...
    try {
        ...
        commit(types.about.mutations.REMOVE_DELETED_ABOUT_SECTION, locationInDataArray);
        commit(types.app.mutations.SET_SPINNER_FLAG, false)
    } catch (error) {
        commit(types.app.mutations.SET_SPINNER_FLAG, false)
        throw error
...
const deleteAboutColumnData = async ({ commit }, payload) => {
    ...
    try {
        ...
        commit(types.about.mutations.REMOVE_DELETED_ABOUT_COLUMN, locationInDataArray);
        commit(types.app.mutations.SET_SPINNER_FLAG, false)
    } catch (error) {
        commit(types.app.mutations.SET_SPINNER_FLAG, false)
        throw error
