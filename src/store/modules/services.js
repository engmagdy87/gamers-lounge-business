...
const mutations = {
  [types.services.mutations.SET_SERVICES]: (
    currentState,
    { services, requestSource }
  ) => {
  ...
  [types.services.mutations.SET_WEBSITE_SERVICE]: (
    currentState,
    websiteService
  ) => {
  ...
  [types.services.mutations.SET_HOME_PAGE_SERVICES]: (
    currentState,
    services
  ) => {
    currentState.homePageServices = services;
  },
  [types.services.mutations.SET_IS_HOME_PAGE_SERVICES_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.services.mutations.SET_IS_SERVICE_SECTIONS_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.services.mutations.SET_IS_SERVICE_SECTION_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.services.mutations.SET_IS_SERVICE_ROWS_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.services.mutations.SET_IS_SERVICE_COLUMNS_FETCHED]: (
    currentState,
    flag
  ) => {
  ...
  [types.services.mutations.REMOVE_DELETED_SERVICE_SECTION]: (
    currentState,
    index
  ) => {
    currentState.serviceSections.sections.data.splice(index, 1);
  },
  [types.services.mutations.REMOVE_DELETED_SERVICE_ROW]: (
    currentState,
    index
  ) => {
    currentState.serviceRows.rows.splice(index, 1);
  },
  [types.services.mutations.REMOVE_DELETED_SERVICE_COLUMN]: (
    currentState,
    index
  ) => {
...
const fetchServicesData = async ({ commit }, payload) => {
  ...
  try {
    ...
    commit(types.services.mutations.SET_SERVICES, {
      services: response,
      requestSource
    });
...
const deleteServiceData = async ({ commit }, payload) => {
  ...
  try {
    ...
    commit(
      types.services.mutations.REMOVE_DELETED_SERVICE,
      locationInDataArray
    );
    commit(types.app.mutations.SET_SPINNER_FLAG, false);
  } catch (error) {
